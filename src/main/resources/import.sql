...
INSERT INTO teacher (id, first_name, last_name, room_number)
VALUES (1, 'Gerald', 'Aistleitner', 35),
       (2, 'Peter', 'Bauer', 120),
...
VALUES (1, 'Cybersecurity Enhancement Initiative',
        'Develop advanced strategies for enhancing cybersecurity measures within the school network.'),
       (2, 'Data Analytics for Academic Performance',
        'Implement data analytics techniques to analyze academic performance data and provide insights for improvement.'),
       (3, 'Virtual Reality in Education',
        'Explore the integration of virtual reality technologies to enhance the learning experience in various subjects.'),
       (4, 'Blockchain for School Records',
        'Investigate the feasibility of using blockchain technology to secure and manage school records efficiently.'),
       (5, 'Coding Challenge Platform',
        'Develop a platform for organizing coding challenges to promote programming skills among students.');

INSERT INTO project_teacher (project_id, teacher_id)
VALUES (1, 1),
       (1, 2),
       (2, 3),
       (2, 6),
...
INSERT INTO student (catalog_number, clazz, first_name, last_name)
VALUES (1, '4XHIF', 'Sophie', 'Mueller'),
...
INSERT INTO task (id, title, hours_worked, project_id, student_catalog_number, student_clazz)
VALUES (1, 'Database Design for New Project', 18, 2, 1, '4XHITM'),
